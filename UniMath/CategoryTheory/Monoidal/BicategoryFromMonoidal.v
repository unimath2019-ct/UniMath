...
(* Defines a monoidal category. *)


(* Takes a monoidal category into a bicategory. *)
...
(* The bicategory is given by the unit type and the objects of the monoidal category as
   morphisms. The 2-cells are given by the morphisms. *)
...
Proof.
  ...
  (* The pentagon equation is backwards on the definition of bicategory from the definition of
  monoidal category. *)
